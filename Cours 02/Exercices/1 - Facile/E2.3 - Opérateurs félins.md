# 🐾 Exercices Python – Opérateurs félins 🐾

## 🎯 Instructions

Complétez les exercices ci-dessous en Python. Chaque exercice est lié à une situation féline et utilise des opérateurs d'assignation ou mathématiques.
...
2. Si le chat a un niveau de bonheur de 50, reçoit des caresses (+20 bonheur), puis prend un bain (-15 bonheur). Quel sera son niveau de bonheur final?
3. Si le chat a 5 jouets, qu'on les multiplie par 2, puis les divise par 5. Quel sera le nombre final de jouets?
4. Il y a 50 croquettes. Quel sera le reste pour chacun des chats si on le divise en 3?
...
9. Si le chat a 3 vies et qu'il gagne 2 vies supplémentaires, combien de vie aura-t-il à la fin?
